...
public class ShareData {
    ...
    public static void main(String[] args) {
        ...
        String json = "{ \"ip\": \"123.45.67.89\" }"; // Replace with actual IP info

        // Prepare the request
        RequestBody body = RequestBody.create(json, MediaType.get("application/json; charset=utf-8"));
        Request request = new Request.Builder()
                .url("https://api.zoominfo.com/v2/endpoint") // Replace with actual ZoomInfo endpoint
                .addHeader("Authorization", "Bearer YOUR_API_TOKEN") // Replace with your API token
                .post(body)
                .build();
